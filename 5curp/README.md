...
```shell
cd $YTVA_DARK_PREFIX/5curp/input/atomgroup
python3 ../../utilize_script/get_dimer_residue_group.py $YTVA_DARK_PREFIX/0structure/output/atominfo.dat dimer
```
